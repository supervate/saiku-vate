...
public class BasicRepositoryResource2 implements ISaikuRepository {
    ...
    public void setAddQueryApi(String addQueryApi) {
        this.addQueryApi = addQueryApi;
    }

    public void setDeleteQueryApi(String deleteQueryApi) {
        this.deleteQueryApi = deleteQueryApi;
    }
    ...
    public Response getResource(@QueryParam("file") String file) {
        String username = sessionService.getAllSessionObjects().get("username") + "";
        List<String> roles = (List<String>) sessionService.getAllSessionObjects().get("roles");
...
*/
    ...
    public Response saveResource(
        ...
        if (resp.equals("Save Okay")) {
            ...
            return Response.serverError().entity("查询方案保存失败: ( 文件名：" + file + ")").header("Content-Type","text/plain; charset=utf-8").build();
        }
		/*
